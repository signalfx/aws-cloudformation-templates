...
| all features [per account resources](latest/template_all_features_per_account.yaml)<br/> and [per region resources](latest/template_all_features_regional.yaml) | yes            | yes             |in each region |[deploy this once per account](https://console.aws.amazon.com/cloudformation/home?region=eu-central-1#/stacks/create/review?templateURL=https://o11y-public.s3.amazonaws.com/aws-cloudformation-templates/release/template_all_features_per_account.yaml) then [deploy this in every region](https://console.aws.amazon.com/cloudformation/home?region=eu-central-1#/stacks/create/review?templateURL=https://o11y-public.s3.amazonaws.com/aws-cloudformation-templates/release/template_all_features_regional.yaml)|https://o11y-public.s3.amazonaws.com/aws-cloudformation-templates/release/template_all_features_regional.yaml <br/><br/> https://o11y-public.s3.amazonaws.com/aws-cloudformation-templates/release/template_all_features_per_account.yaml|no
...
| logs [per account resources](logs/template_logs_per_account.yaml)<br/>  and [per region resources](logs/template_logs_regional.yaml)                         | yes            | no              |in each region|[deploy this once per account](https://console.aws.amazon.com/cloudformation/home?region=eu-central-1#/stacks/create/review?templateURL=https://o11y-public.s3.amazonaws.com/aws-cloudformation-templates/release/template_logs_per_account.yaml) then [deploy this in every region](https://console.aws.amazon.com/cloudformation/home?region=eu-central-1#/stacks/create/review?templateURL=https://o11y-public.s3.amazonaws.com/aws-cloudformation-templates/release/template_logs_regional.yaml)|https://o11y-public.s3.amazonaws.com/aws-cloudformation-templates/release/template_logs_per_account.yaml <br/><br/> https://o11y-public.s3.amazonaws.com/aws-cloudformation-templates/release/template_logs_regional.yaml|yes
...
| metric streams [per account resources](metric-streams-beta/template_metric_streams_per_account.yaml)<br/>  and [per region resources](metric-streams-beta/template_metric_streams_regional.yaml)    | no             | yes             |in each region|[deploy this once per account](https://console.aws.amazon.com/cloudformation/home?region=eu-central-1#/stacks/create/review?templateURL=https://o11y-public.s3.amazonaws.com/aws-cloudformation-templates/release/template_metric_streams_per_account.yaml) then [deploy this in every region](https://console.aws.amazon.com/cloudformation/home?region=eu-central-1#/stacks/create/review?templateURL=https://o11y-public.s3.amazonaws.com/aws-cloudformation-templates/release/template_metric_streams_regional.yaml)|https://o11y-public.s3.amazonaws.com/aws-cloudformation-templates/release/template_metric_streams_per_account.yaml <br/> <br/>|no
...
3. Copy the following link and replace `REGION` with region code of your region (for example `cn-northwest-1`)
    ```
   https://console.aws.amazon.com/cloudformation/home?region=REGION/stacks/create/review?templateURL=https://o11y-public.s3.amazonaws.com/aws-cloudformation-templates/release/template_logs_per_account.yaml
    ```
    Deploy the template. It will create resources which will be reused by resources in all regions.
4. For each region from which you wish to collect logs, copy the following link and replace `REGION` with region code (for example `cn-northwest-1`), then deploy the template.
    ```
...
| SplunkLogIngestUrl | your Splunk Observability ingest url with an additional suffix `/v1/log`. You can find ingest url in `Profile --> Account Settings --> Endpoints --> Real-time Data Ingest`. For example, if your ingest url is `https://ingest.us0.signalfx.com` then the variable should be set to `https://ingest.us0.signalfx.com/v1/log`   |
| SplunkCloudIngestUrl | Real-time Data Ingest url from your account. That is the same endpoint as SplunkLogIngestUrl, but without the suffix. In our example, the value would be `https://ingest.us0.signalfx.com`. |
| SplunkMetricsIngestUrl | Real-time Data Ingest url from your account. That is the same endpoint as SplunkLogIngestUrl, but without the suffix. In our example, the value would be `https://ingest.us0.signalfx.com`. Splunk uses this to monitor the usage and adoption of aws-collector-lambda.   |
